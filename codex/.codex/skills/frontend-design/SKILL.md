...
Agent automatically uses this skill for frontend work. Creates production-ready code with:
...
Agent will choose a clear aesthetic direction and implement production code with meticulous attention to detail.
